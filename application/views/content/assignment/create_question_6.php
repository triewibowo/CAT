                ...
                <div id="option_">
                    <?php for ($i=0; $i < 1 ; $i++) : ?>
                        ...
                        <div class="row" id="rowAnswer">
                            ...
                            <div class="col-sm-11">
                                <div class="row mb-2">
                                    <!-- <input class="form-control col mr-3" name="option_<?= $i ?>" placeholder="Teks Jawaban"></input> -->
                                    <textarea data-toggle="tinymce" name="option_<?= $i ?>" data-plugin-options='{ "height": 150 }'></textarea>
                                </div>
                                <div class="row">
                                <div class="col-lg-2">
                                        <label>
                                            <input type="radio" name="answer_<?= $i ?>" value="true">
                                            Benar
                                        </label>
                                    </div>
                                    <div class="col-lg-2">
                                        <label>
                                            <input type="radio" name="answer_<?= $i ?>" value="false">
                                            Salah
                                        </label>
                                    </div>
                                </div>
                            ...
                            _html += '<div class="row" id="rowAnswer'+totalAnswer+'">';
                                ...
                                _html += '<div class="col-sm-11">';
                                    ...
                                    _html += '<textarea class="form-control text-blank" style="height:150px" name="option_'+totalAnswer+'" id="textareaBlank'+totalAnswer+'"></textarea>';
                                        ...
                                        // _html += '<textarea data-toggle="tinymce" name="option_'+totalAnswer+'" data-plugin-options='{ "height": 150 }'></textarea>'
                                    _html += '</div>'
                                        _html += '<div class="row">'
                                            _html += '<div class="col-lg-2">'
                                                _html += '<label><input type="radio" name="answer_'+totalAnswer+'" value="true">Benar</label>'
                                            _html += '</div>'
                                            _html += '<div class="col-lg-2">'
                                                _html += '<label><input type="radio" name="answer_'+totalAnswer+'" value="false">Salah</label>'
                                            _html += '</div>'
                                        _html += '</div>'
