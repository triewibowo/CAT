                ...
                <input type="hidden" name="id_student" value="<?= $dataStudent->id_student ?>">
                  <div class="row">
                   <div class="col-md-6">
                       ...
                       <div class="form-group">
                           <label>NIS</label>
                           <input type="text" class="form-control" name="student_nis" placeholder="NIS" required value="<?= $dataStudent->student_nis ?>">
                       </div>
                       <div class="form-group">
                           <label>Password</label>
                           <input type="password" class="form-control" name="student_password" placeholder="Boleh dikosongkan">
                       </div>
                       <div class="row">
                         <div class="col-sm-6">
                           <div class="form-group">
                               <label>Email</label>
                               <input type="email" class="form-control" name="student_email" placeholder="info@youremail.com" value="<?= $dataStudent->student_email ?>" required>
                           </div>
                         </div>
                         <div class="col-sm-6">
                           <div class="form-group">
                               <label>Nomor Telepon</label>
                               <input type="number" class="form-control" name="student_phone" placeholder="Nomor Telepon" value="<?= $dataStudent->student_phone ?>">
                           </div>
                         </div>
                       </div><!-- / Row -->
                       <div class="form-group">
                           ...
                           <select class="form-control" name="id_class">
                             <?php foreach ($dataClasses as $row => $value): ?>
                               <option <?php if ($value->id_class == $dataStudent->id_class): echo "selected"; endif; ?> value="<?= $value->id_class ?>"><?= $value->class_name ?></option>
                             <?php endforeach ?>
                           </select>
                       </div>
                   </div>
