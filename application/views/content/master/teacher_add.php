    ...
    <div class="widget-holder widget-full-height col-md-12">
        <div class="widget-bg">
            <div class="widget-body">
               <form action="<?= site_url('MasterCtrl/teachers') ?>" method="POST" enctype="multipart/form-data">
                   <div class="row">
                       <div class="col-md-6">
                           <div class="form-group">
                               <label>Nama Lengkap</label>
                               <input type="text" class="form-control" name="teacher_name" placeholder="Nama Lengkap" required>
                           </div>
                           <div class="form-group">
                               <label>Username</label>
                               <input type="text" class="form-control" name="teacher_username" placeholder="Username" required>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                               <label>Email</label>
                               <input type="email" class="form-control" name="teacher_email" placeholder="info@youremail.com">
                           </div>
                           <div class="form-group">
                               <label>Nomor Telepon</label>
                               <input type="number" class="form-control" name="teacher_phone" placeholder="Nomor Telepon">
                           </div>
                           <div class="form-group">
                               <label>Alamat</label>
                               <input type="text" class="form-control" name="teacher_address" placeholder="Alamat">
                           </div>
                       </div>
                       <div class="col-md-6">
                            <div class="form-group">
                                   ...
                                   <table class="table table-stripped table-hover">
                                       ...
                                       <tbody>
                                            <?php foreach ($dataClasses as $rowClass => $valueClass): ?>
                                               <tr>
                                                   <td><input type="checkbox" name="id_class[]" value="<?= $valueClass->id_class ?>"></td>
                                   ...
                                   <table class="table table-stripped table-hover">
                                       ...
                                       <tbody>
                                            <?php foreach ($dataLessons as $rowLesson => $valueLesson): ?>
                                               <tr>
                                                   <td><input type="checkbox" name="id_lesson[]" value="<?= $valueLesson->id_lesson ?>"></td>
