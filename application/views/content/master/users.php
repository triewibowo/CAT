...
<div class="row page-title clearfix" style="margin-top:-10px">
    <div class="page-title-left">
        <h6 class="page-title-heading mr-0 mr-r-5">Data Pengguna </h6>
    ...
    <div class="widget-bg">
        <div class="widget-body">
            <div class="row mb-3">
                ...
                <div class="col-sm-2">
                    <a href="#add" data-toggle="modal" class="btn btn-success btn-sm float-right"><i class="feather feather-plus"></i> Create</a>
                </div>
            </div>
