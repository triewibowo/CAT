...
<div class="row page-title clearfix" style="margin-top:-10px">
    <div class="page-title-left">
        <h6 class="page-title-heading mr-0 mr-r-5">Analysis Ujian</h6>
    ...
    <div class="page-title-right d-inline-flex">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Analysis Ujian</li>
        </ol>
    </div>
</div><!-- /.page-title -->
    ...
    <div class="widget-holder widget-full-height col-md-12">
        <div class="widget-bg">
            <div class="widget-body">
                <form action="<?= site_url('page/analytics') ?>" method="POST">
                <div class="row">
                    <div class="col-sm-3">
                                ...
                                <div id="boxResult<?= $r ?>">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4" style="text-align:right">
                                            <a href="<?= site_url('page/analytics_pdf/'.$v->id_assignment.'/'.$dataClass->id_class) ?>" target="_blank" class="pull-right btn btn-danger btn-sm"><i class="feather feather-download"></i>&nbsp; Download Pdf</a>
                                        </div>
                                    </div><!-- / Row -->
                                    <table class="table table-striped table-hover">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th style="width:40%">Petanyaan</th>
                                                <th>Benar</th>
                                                <th>Salah</th>
                                                <th>Tidak Diisi</th>
                                        ...
                                        <tbody>
                                            <?php $n = 1; foreach ($v->questions as $rQuestion => $vQuestion): ?>
                                                <tr>
                                                    ...
                                                    <td><?= $vQuestion->true ?> Orang</td>
                                                    <td><?= $vQuestion->false ?> Orang</td>
                                                    <td><?= $vQuestion->empty ?> Orang</td>
                                                    <td><?= $vQuestion->notYet ?> Orang</td>
                                                </tr>
                                            <?php $n++; endforeach ?>
                                        </tbody>
                                    </table>
